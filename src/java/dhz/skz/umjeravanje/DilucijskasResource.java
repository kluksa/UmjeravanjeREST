 ...
 */
@Path("/dilucijska")
public class DilucijskasResource {
     ...
     */
    public DilucijskasResource() {
    }

    /**
     * Retrieves representation of an instance of dhz.skz.umjeravanje.DilucijskasResource
     * @return an instance of java.util.List<dhz.skz.umjeravanje.dto.Dilucijska>
     */
    @GET
    @Produces("application/xml")
    public java.util.List<dhz.skz.umjeravanje.dto.Dilucijska> getXml() {
        return uredjajFacade.findAll().stream()
                ...
                .map(new DilucijskaBuilder()::build)
                .collect(Collectors.toList());
    }

    /**
     * POST method for creating an instance of DilucijskaResource
    ...
    @Produces("application/xml")
    public Response postXml(Dilucijska content) {
        //TODO
...
//        return Response.created(context.getAbsolutePath()).build();
     ...
     */
    @Path("{id}")
    public DilucijskaResource getDilucijskaResource(@PathParam("id") String id) {
        return DilucijskaResource.getInstance(id);
    }
